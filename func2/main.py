...
class Argument:
    def __init__(self):
        ...
        self.func = ["0*x"]
        # 需要拟合的函数
        self.start = [-1,0]        # 生成拟合数据的区间
        self.end = [1]          # 生成拟合数据的区间
        ...
        self.path = ['func2/model_x1','func2/model_x2','func2/model_x3','func2/model_x4','func2/model_x5']
...
for i in range(5):
    ...
    # 定义输入数据和目标数据
    generator = dataGenerator(args.func[0], args.start[0], args.end[0]+args.step, args.step)
    x, y = generator.generate_data()
    y[100] = torch.tensor(2**(i-1))
