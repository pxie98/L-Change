...
class Argument:
    def __init__(self):
        ...
        self.path = ['func6/model_x1','func6/model_x2','func6/model_x3','func6/model_x4','func6/model_x5']
...
for i in range(5):
    ...
    # 定义输入数据和目标数据
    generator = dataGenerator(args.func[0], args.start[0], args.end[0], args.step, args.num_points, args.coff[0])
    x, y = generator.generate_data()
    y[20200][0] = torch.pow(torch.tensor(2), torch.tensor(i-1))
