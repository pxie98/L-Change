...
class Argument:
    def __init__(self):
        ...
        self.path = ['func5/model_x1','func5/model_x2','func5/model_x3','func5/model_x4','func5/model_x5']
...
for i in range(2):
    ...
    # 定义输入数据和目标数据
    generator = dataGenerator(args.func[0], args.start[0], args.end[0], args.step, args.num_points, args.coff[i])
