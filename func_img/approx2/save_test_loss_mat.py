...
class Argument:
    def __init__(self):
        ...
        self.hidden_size_list = [50,300]           #range(1, 10+1, 1)  # 每一层NN的参数维度
        self.jianges = [2,4,8,16,32,64,128]

        # 训练阶段的参数
        self.learning_rate = 0.0005     # 模型训练的学习率
        self.num_epochs = 200001         # 模型训练的迭代次数
        self.path = ['func_img/approx2/model_x1','func_img/approx2/model_x2','func_img/approx2/model_x3','func_img/approx2/model_x4','func_img/approx2/model_x5','func_img/approx2/model_x6','func_img/approx2/model_x7']
...
def all_pic(args, device, i):
    ...
    for layer_num in args.layer_num_list:
        for hidden_size in args.hidden_size_list:
            ...
            mat_file_name = 'func_img/approx2/matfile/layer{}hz{}f{}_alldata_randomx_chazhi{}.mat'.format(layer_num, hidden_size,i, jiange)
            savemat(mat_file_name, {'x':x.detach().clone().tolist() , 'y': outputs_all})
