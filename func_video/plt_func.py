...
def plot_3d_png(filename, title, fig_name, t, end_num):
    end_threshold = 20
    z_threshold = 7.0
...
for i in range(4):
    ...
    t = t_all[i]
    plot_3d_png(filename, title, fig_name, t, end_num)'
'''

loss_model_layer4_hidden100 = [0.3597310185432434, 0.48859527707099915, 0.4298565983772278, 0.6762591004371643, 0.8571830987930298, 0.26867470145225525, 0.3730725646018982, 0.2753629982471466, 0.5372263789176941, 0.39856478571891785, 0.5130456686019897, 0.4071936309337616, 0.4816402792930603, 0.5050346851348877, 0.5218561291694641, 0.7726762294769287, 0.7448159456253052, 0.5464884042739868, 0.4650481045246124, 0.5107672214508057, 0.9526305794715881]
x = range(0,20001,1000)

# 创建图形
plt.plot(x, loss_model_layer4_hidden100, marker='o')  # marker='o' 表示在数据点上画圆圈
