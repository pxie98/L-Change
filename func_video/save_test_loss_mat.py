...
class Argument:
    def __init__(self):
        ...
        self.path = ['func_img/approx2/model_x1','func_img/model_x2','func_img/model_x3','func_img/model_x07281','func_linear/model_x07282','func_linear/model_x07284','func_linear/model_x07288']
...
def all_pic(args, device, i):
    ...
    for layer_num in args.layer_num_list:
        for hidden_size in args.hidden_size_list:
            ...
            mat_file_name = 'func_img/approx2/matfile/layer{}hz{}f{}_alldata_randomx.mat'.format(layer_num, hidden_size,i)
